...
const createSlideshowTwitchWebsocketHttp = async (req, res) => {
    const { hash } = req.body;
    const subscriptionTypes = ["channel.subscribe", "channel.subscription.message", "channel.follow"];
...
module.exports = createSlideshowTwitchWebsocketHttp